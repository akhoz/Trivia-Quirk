...
public enum Basket {
    ...
    PREGUNTA_13("¿Quién ganó el premio MVP de la NBA para la temporada 2021-2022?", "LeBron James", "Kevin Durant", "Stephen Curry", (byte) 4),
    PREGUNTA_14("¿Cuál es el término para la zona en la cancha de baloncesto donde un jugador lanza tiros libres?", "Área pintada", "Perímetro", "Línea de falta", (byte) 4),
